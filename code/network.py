...
class DoubleDQN:
    def __init__(self,
        ...
        self.cost_his = []               #recording error

    def _build_net(self):
        def build_layers(s, c_names, n_l1, w_initializer, b_initializer):  #s is the input n_l1 is the number of l1 neurons, and the last two parameters are the weights and bias initialization method
            with tf.compat.v1.variable_scope('l1'):
                ...
                l1 = tf.nn.relu(tf.matmul(s, w1) + b1)   #Change inputs less than 0 to 0 No change in inputs greater than 0
    ...
    def choose_action(self, observation):
        ...
        self.q.append(self.running_q/10)
